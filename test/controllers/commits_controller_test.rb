...
class CommitsControllerTest < ActionController::TestCase
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post :create, commit: { author: @commit.author, comment: @commit.comment, date: @commit.date, sha1: @commit.sha1 }
    end
  ...
  test "should update commit" do
    patch :update, id: @commit, commit: { author: @commit.author, comment: @commit.comment, date: @commit.date, sha1: @commit.sha1 }
    assert_redirected_to commit_path(assigns(:commit))
  end
